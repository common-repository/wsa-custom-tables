<?php
/**
 * Plugin Name: WSA Tables Module for Beaver Builder 
 * Plugin URI: http://bb.webstudioagency.com
 * Description: The easiest way to create tables with Beaver Builder
 * Version: 1.0
