...
/**
 * This is tables module from WEBSTUDIO Agency S.r.l. 2018
 * www.webstudioagency.it
 * @class FLBasicTableModule
 */
class FLWsaTableModule extends FLBuilderModule
{
     ...
     * the function passes name, description, dir and url in an array to the parent class.
     *
     * @method __construct
     */
